  ...
  <div class="list-page">
    <commonalityHeader :name="headerName" :operation="operation" :flag="false" :back="true">
      <div class="slot" slot="right">
          <span @click="$router.push('/c_page/deliver/inquire')"><i class="iconfont icon-search"></i></span>
      </div>
    </commonalityHeader>
  ...
  methods: {
    ...
    query(){
      ...
      this.task0_criteria = {"signerTel": this.signerTel, "signerTimeBegin": this.signerTimeBegin, "signerTimeEnd": this.signerTimeEnd, 
               "searchKey": this.searchKey, "isNonSigned": "1", "pageNo": this.pageNo, "pageSize": this.pageSize};
      this.task1_criteria = {"signerTel": this.signerTel, "signerTimeBegin": this.signerTimeBegin, "signerTimeEnd": this.signerTimeEnd, 
               "searchKey": this.searchKey, "isCompleted": "0", "pageNo": this.pageNo, "pageSize": this.pageSize};
      this.task2_criteria = {"signerTel": this.signerTel, "signerTimeBegin": this.signerTimeBegin, "signerTimeEnd": this.signerTimeEnd, 
               "searchKey": this.searchKey, "isCompleted": "1", "pageNo": this.pageNo, "pageSize": this.pageSize};
    }
  },
  mounted () {
